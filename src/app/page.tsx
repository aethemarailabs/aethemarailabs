  ...
  return (
    <>
      ...
      <main className="flex-grow pt-20">
          ...
          <div className="grid md:grid-cols-12 gap-gutter items-center">
            <div className="md:col-span-5 relative">
              <div className="aspect-[4/5] rounded-xl overflow-hidden glass-panel glow-box p-2">
                <div className="w-full h-full rounded-lg bg-surface-container-high relative overflow-hidden group flex items-center justify-center">
                  <Image 
                    src="/nameTag/119457.png" // using the name tag image
                    alt="CEO Portrait" 
                    fill 
                    className="object-cover opacity-70 group-hover:opacity-90 transition-opacity duration-700 mix-blend-luminosity" 
                    unoptimized
                  />
            ...
            <div className="md:col-span-7 space-y-8 md:pl-12">
              ...
              <div className="space-y-6 font-body-md text-on-surface-variant text-lg">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-6 border-t border-white/5">
                  <div className="flex gap-4 items-start">
                    ...
                    <div>
                      <h4 className="font-bold text-on-surface mb-1">Corporate Mastery</h4>
                  ...
                  <div className="flex gap-4 items-start">
                    ...
                    <div>
                      <h4 className="font-bold text-on-surface mb-1">Media Presence</h4>
        ...
        {/* Services Section */}
        <section id="services" className="py-24 px-margin-mobile md:px-margin-desktop bg-surface-container-low/50 border-y border-white/5">
          <div className="max-w-container-max mx-auto">
            <div className="text-center mb-16 space-y-4">
              <h2 className="font-headline-lg text-headline-lg-mobile md:text-headline-lg">Our Capabilities</h2>
        ...
        <section id="portfolio" className="py-24 px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto">
          <div className="flex flex-col items-center text-center space-y-12">
            <div className="space-y-4">
              <h2 className="font-headline-lg text-headline-lg-mobile md:text-headline-lg">The Aether Network</h2>
        ...
        {/* Contact Section */}
        <section id="contact" className="py-24 px-margin-mobile md:px-margin-desktop bg-surface-container-lowest border-t border-white/5">
          <div className="max-w-4xl mx-auto glass-panel p-8 md:p-16 rounded-2xl glow-box relative overflow-hidden">
            <div className="relative z-10 grid md:grid-cols-2 gap-16">
              <div className="space-y-8">
                <div>
                  <h2 className="font-headline-lg text-headline-lg-mobile md:text-headline-lg mb-4">Initiate Contact</h2>
                  <p className="font-body-md text-on-surface-variant">Ready to elevate your operational reality? Reach out to our secure channel.</p>
                </div>
                <div className="space-y-6">
      ...
      {/* Footer */}
      <footer className="w-full pt-24 pb-12 bg-surface-container-lowest border-t border-outline-variant/20">
        <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop flex flex-col gap-12">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            <div className="font-headline-lg text-headline-lg text-primary flex items-center gap-3">
              <Image 
                src="/logo/119409.png" // using logo
                alt="Aethemar Logo" 
                width={40} 
                height={40} 
                className="h-10 w-auto mix-blend-screen opacity-70" 
                unoptimized
              />
            </div>
            <div className="flex flex-wrap justify-center gap-6 md:gap-8 font-body-md text-body-md">
              ...
              <Link href="#" className="text-on-surface-variant hover:text-primary transition-colors">Brand Kit</Link>
              <Link href="#" className="text-on-surface-variant hover:text-primary transition-colors">Career</Link>
            </div>
          </div>
          <div className="text-center md:text-left font-body-md text-on-surface-variant text-sm opacity-60">
